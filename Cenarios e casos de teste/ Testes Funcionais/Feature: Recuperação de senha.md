...
Feature: Recuperação de senha
  ...
  Scenario: Solicitar recuperação de senha com sucesso  [PASSOU]
  ...
  Scenario: Tentar recuperação com e-mail inválido [PASSOU]
  ...
  Scenario: Tentar recuperação com campo vazio  [PASSOU]
  ...
  Scenario: Validar retorno para e-mail não cadastrado  [PASSOU]
  ...
  Scenario: Validar acesso ao fluxo de redefinição [PASSOU]
  ...
  Scenario: Validar redefinição de senha com sucesso [PASSOU]
  ...
  Scenario: Validar divergência entre senhas [PASSOU]
  ...
  Scenario: Validar responsividade da recuperação de senha no mobile [ NÃO PASSOU] (os formularios todos tem um problema com o layout para tablet)
  ...
  Scenario: Validar responsividade da recuperação de senha no desktop [PASSOU]
