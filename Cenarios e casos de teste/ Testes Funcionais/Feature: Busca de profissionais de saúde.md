...
Feature: Busca de profissionais de saúde
  ...
  Scenario: Buscar profissional com sucesso
    When preencher o campo de busca com uma especialidade válida [PASSOU]
    And executar a pesquisa
    Then o sistema deve exibir profissionais relacionados à busca

  Scenario: Buscar profissional utilizando localização [ NÃO PASSOU] (sistema exibiu localização errada)
  ...
  Scenario: Buscar profissional sem preencher filtros [PASSOU]
  ...
  Scenario: Validar carregamento da listagem de profissionais [PASSOU]
  ...
  Scenario: Validar responsividade da busca de profissionais no mobile  [PASSOU]
  ...
  Scenario: Validar responsividade da busca de profissionais no desktop  [PASSOU]
